...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="<?= base_url('dashboard') ?>">SI Bimbingan TA/PKMI</a>
    <!-- Sidebar Toggle-->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="d-none d-md-inline">
                    <span class="text-capitalize"><?= staffdata('role'); ?></span> | <?= staffdata('display_name'); ?>
                </div>
            </a>
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <?php if (staffdata('role') == "admin_prodi") : ?>
                ...
                <?php if (staffdata('role') == "kaprodi") : ?>
                    <a class="nav-link" href="<?=base_url('pengajuan/data')?>">
                    <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                    Pengajuan Judul TA/PKMI
                </a>
                <?php endif; ?>
                <?php if (staffdata('role') == "dosen") : ?>
                    <a class="nav-link" href="<?=base_url('bimbingan/data')?>">
                        <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                        Bimbingan TA/PKMI
                    </a>
                <?php endif; ?>
                <?php if (staffdata('role') == "admin_prodi") : ?>
                    <a class="nav-link" href="<?=base_url('bimbingan/buat_kartu_bimbingan')?>">
                        <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                        Buat Kartu Bimbingan
                    </a>
                <?php endif; ?>
            </div>
        </div>
